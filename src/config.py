...
class Config:
    ...
    MISSED_TICKET_CHECK_INTERVAL_SECONDS = int(os.getenv("MISSED_TICKET_CHECK_INTERVAL_SECONDS", "3600"))
    MISSED_TICKET_LOOKBACK_SECONDS = int(os.getenv("MISSED_TICKET_LOOKBACK_SECONDS", "86400"))
